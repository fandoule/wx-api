...
public class WxAssetsServiceImpl implements WxAssetsService {
    ...
    @Override
    @Cacheable(key = "#root.target.getLocal() + methodName")
    ...
    @Override
    @Cacheable(key="#root.target.getLocal() + methodName + #mediaId")
    ...
    @Override
    @Cacheable(key="#root.target.getLocal() + methodName + #type + #page")
    ...
    @Cacheable(key = "#root.target.getLocal() + methodName + #page")
    @Override
